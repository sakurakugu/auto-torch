...
final class DualRangeSlider extends Button {
    ...
    protected void renderButton(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(Minecraft.getMinecraft().fontRendererObj, getMessage(), xPosition + width / 2, yPosition + 5, 0xFFFFFFFF);
    }

    private void thumb(int thumbX, boolean hovered) {
        drawNineSliced(thumbX - 4, yPosition, 8, height, 20, 4, 200, 20, 0, hovered ? 60 : 40);
    }
