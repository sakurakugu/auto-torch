...
public final class LightOverlayRenderer {
    ...
    private static void renderData(Vec3d camera, RenderData data, boolean waterVisible) {
    ...
    private static void renderLines(Vec3d camera, RenderData data, boolean waterVisible) {
        if (data.lineCount() == 0) {
            return;
        }
        if (waterVisible) {
    ...
    private static void renderNumbers(Vec3d camera, RenderData data, boolean waterVisible) {
    ...
    private static void submitLines(Pose pose, VertexConsumer buffer, RenderData data, Vec3d camera) {
    ...
    private static void submitNumbers(Pose pose, VertexConsumer buffer, RenderData data, Vec3d camera) {
        ...
        for (NumberQuad quad : data.numberQuads()) {
            ...
            float x = (float) (quad.x() - camera.xCoord);
            float y = (float) (quad.y() - camera.yCoord);
            float z = (float) (quad.z() - camera.zCoord);
    ...
    private static void line(
            ...
            int color, float lineWidth, Vec3d camera
    ) {
