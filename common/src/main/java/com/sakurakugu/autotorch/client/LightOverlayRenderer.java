...
public final class LightOverlayRenderer {
    ...
    private static void renderNumbers(Vec3 camera, RenderData data, boolean waterVisible) {
        ...
        submitNumbers(Pose.INSTANCE, new VertexConsumer(tesselator), data, camera);
        tesselator.draw();
    ...
    private static EnumFacing numberFacing() {
        ...
        int horizontalIndex = (int) Math.floor((view == null ? 180.0D : view.rotationYaw) / 90.0D + 0.5D) & 3;
