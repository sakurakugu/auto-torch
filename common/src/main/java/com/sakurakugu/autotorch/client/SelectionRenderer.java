...
public final class SelectionRenderer {
    ...
    private static void renderLineZone(
        ...
        if (zone.shape() == AreaShape.SPHERE) {
            ...
            renderBoxLines(pose, buffers, fullBlockBounds(zone), lineColor, width, camera);
        }
    }
    ...
    private static void quad(
        ...
        buffer.vertex(pose.pose(), (float) (x1 - camera.x()), (float) (y1 - camera.y()), (float) (z1 - camera.z())).color(color).endVertex();
        buffer.vertex(pose.pose(), (float) (x2 - camera.x()), (float) (y2 - camera.y()), (float) (z2 - camera.z())).color(color).endVertex();
        buffer.vertex(pose.pose(), (float) (x3 - camera.x()), (float) (y3 - camera.y()), (float) (z3 - camera.z())).color(color).endVertex();
        buffer.vertex(pose.pose(), (float) (x4 - camera.x()), (float) (y4 - camera.y()), (float) (z4 - camera.z())).color(color).endVertex();
    }
