...
public final class SelectionRenderer {
    ...
    private static void quad(
        ...
        applyColor(buffer.vertex(pose.pose(), (float) (x1 - camera.x), (float) (y1 - camera.y), (float) (z1 - camera.z)), color).endVertex();
        applyColor(buffer.vertex(pose.pose(), (float) (x2 - camera.x), (float) (y2 - camera.y), (float) (z2 - camera.z)), color).endVertex();
        applyColor(buffer.vertex(pose.pose(), (float) (x3 - camera.x), (float) (y3 - camera.y), (float) (z3 - camera.z)), color).endVertex();
        applyColor(buffer.vertex(pose.pose(), (float) (x4 - camera.x), (float) (y4 - camera.y), (float) (z4 - camera.z)), color).endVertex();
    }
