...
适用于 Minecraft 1.7.10~26.2 / NeoForge、Forge 和 Fabric 的自动插火把和光照显示模组。
...
本地自动打开游戏并执行冒烟测试（默认使用 Fabric 和最近修改的单人存档）：

```powershell
python .\tools\本地自动测试.py
python .\tools\本地自动测试.py --loader neoforge
```
