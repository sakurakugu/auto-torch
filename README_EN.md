...
An automatic torch placement and light level overlay mod for Minecraft 1.11.2 on Forge.

> For other supported versions, see the corresponding `mc/<version>` branch.
...
Building requires Java 21; the generated mod runs on Java 8:
